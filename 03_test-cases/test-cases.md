...
| TC-034 | Checkout robustness: very long inputs | Checkout Step One | 1) Enter 200+ chars in First/Last<br>2) Click **Continue**  | App doesn’t break UI/crash; shows validation or accepts safely | Negative | Medium | - | - | - |
